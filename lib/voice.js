...
function Message() {
    this.appid = config.voiceConfig.appid;
    this.signtype = config.voiceConfig.signtype;
    this.appkey = config.voiceConfig.appkey;
    this.code_uri = config.voiceConfig.code_uri;
    this.xsend_uri = config.voiceConfig.xsend_uri;
    this.send_uri = config.voiceConfig.send_uri;
    this.multiXsend_uri = config.voiceConfig.multiXsend_uri;
    this.timestamp_uri = config.timestampConfig.timestamp_uri;

    this.verify = function(params) {
        var api = this.code_uri;
