...
function MMS() {
    this.appid = config.mmsConfig.appid;
    this.signtype = config.mmsConfig.signtype;
    this.appkey = config.mmsConfig.appkey;
    this.xsend_uri = config.mmsConfig.xsend_uri;
    this.send_uri = config.mmsConfig.send_uri;
    this.multiXsend_uri = config.mmsConfig.multiXsend_uri;
